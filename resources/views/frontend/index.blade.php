        ...
        <div class="side-menu animate-dropdown outer-bottom-xs">
          ...
          <nav class="yamm megamenu-horizontal">
            <ul class="nav">
              ...
              <li class="dropdown menu-item"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="{{$category->category_icon}}" aria-hidden="true"></i>@if (session()->get('language')=='bangla'){{$category->category_name_bn}} @else {{$category->category_name_en}} @endif</a>
                    ...
                    <div class="products">
                      <div class="product">
                        ...
                        <div class="product-info text-left">
                          ...
                          @if($product->discount_price==Null)
                          <div class="product-price"> <span class="price"> {{round($amount)}} </span></div>
                          @else

                          <div class="product-price"> <span class="price"> {{round($amount)}} </span> <span class="price-before-discount">{{$product->selling_price}}</span> </div>
                          <!-- /.product-price --> 
                          @endif
                          <!-- /.product-price --> 
