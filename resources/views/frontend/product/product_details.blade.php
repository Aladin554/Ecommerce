...
<img src="{{ asset('frontend/assets/images/banners/LHS-banner.jpg') }}" alt="Image">
		...
		@include('frontend.tag.hot_deals')
								...
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="price-box">
                                            ...
                                            <span class="price">{{round($amount)}}</span>
							...
							<div class="tab-content">
								...
								<div id="description" class="tab-pane in active">
									<div class="product-tab">
										<p class="text">@if (session()->get('language')=='bangla'){!! $product->long_descp_bn !!} @else {!! $product->long_descp_en !!} @endif</div>	
								</div><!-- /.tab-pane -->
