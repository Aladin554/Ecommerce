...
<img class="rounded-circle" src="{{ $adminData->profile_photo_path ?
 asset('storage/profile_photo_path/' . $adminData->profile_photo_path) : asset('storage/no_image/no_image.png') }}"
 alt="">
